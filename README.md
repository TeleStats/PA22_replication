...
We provide a google colab notebook to reproduce the experiments from tables 3-6 and figures 5-6.
The replicator should be able to replicate the results for the different configurations considering **channel**, **detector**, and **classifier** presented in the paper.
